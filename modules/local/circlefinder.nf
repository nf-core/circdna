...
//    }
    ...
    file_exists ${prefix}.split.id-freq4.txt
    awk '{print \$4}' ${concordant} | sort | uniq -c > ${prefix}.concordant.id-freq.txt
    file_exists ${prefix}.concordant.id-freq.txt
    ...
    awk '\$1==\$10 && \$7==\$16 && \$6>0 && \$15>0 {print \$1} ' ${prefix}.split_freq2.oneline.txt > \
